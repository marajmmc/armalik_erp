                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                <input disabled="" type="text" name="start_date" id="start_date" class="span9" placeholder="Start Date" value="<?php echo $db->DB_date_convert_year($start_date) ?>" />
                        ...
                        <table class="table table-condensed table-striped table-bordered table-hover no-margin" id="TaskTable">
                            ...
                            for ($i = 0; $i < $rowcount; $i++) {
                                ...
                                <tr class='<?php echo $rowcolor; ?>' id="tr_elm_id<?php echo $i; ?>">
                                    ...
                                    <td>
                                        <input disabled="" type='text' name='quantity[]' maxlength='50' id='quantity<?php echo $i; ?>' class='span12' value='<?php echo $quantity[$i]; ?>' onblur='sum_value()' />
