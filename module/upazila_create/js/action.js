...
function Existin_data()
{
    $("#loader").remove();
    $.post("exist_data.php",{upazilla_name:$("#upazilla_name").val(), zilla_id:$("#zilla_id").val()}, function(result){
        if (result){
            if (result=="Found"){
                ME_Alert('Alert', 'Exiting Your Data');
//                notification_msg('Exiting Your Data');
                $("#upazilla_name").after('<img id="loader" src="../../system_images/fb_loader.gif" />');
