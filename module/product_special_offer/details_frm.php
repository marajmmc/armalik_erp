            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input disabled="" class="span3" type="text" name="quantity" id="quantity" value="<?php echo $editrow['quantity']?>" placeholder="Qty" validate="Require" onkeypress="return numbersOnly(event)" />
                            <span class="help-inline">
                                *
                            </span>
                        </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input disabled="" class="span5" type="text" name="offer" id="offer" value="<?php echo $editrow['offer']?>" placeholder="Offer" validate="Require"  />
                            <span class="help-inline">
                                *
                            </span>
                        </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                <input disabled="" type="text" name="start_date" id="start_date" value="<?php echo $db->date_formate($editrow['start_date']);?>" class="span9" placeholder="Date of birth"  />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                <input disabled="" type="text" name="end_date" id="end_date" value="<?php echo $db->date_formate($editrow['end_date']);?>" class="span9" placeholder="Date of birth"  />
