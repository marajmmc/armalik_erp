...
<!--                                </th>-->
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="product_type_id" name="product_type_id" class="span12" placeholder="Product Type" validate="Require" onchange="load_variety_view()">
                                        <option value="">Select</option>
                                    </select>
                                </td>
...
<!--                                        <i class="icon-print" data-original-title="Share"> </i> View Variety-->
<!--                                    </a>-->
<!--                                </td>-->
                            </tr>
                        </thead>
