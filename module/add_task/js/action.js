...
function RowIncrement() 
{
    ...
    cell1.innerHTML = "<select id='task_status"+ExId+"' name='task_status[]' class='span12' placeholder='Crop'>\n\
    <option value=''>Select</option>\n\
    <option value='In-progress'>In-progress</option>\n\
    <option value='Pending'>Pending</option>\n\
    <option value='Completed'>Completed</option>\n\
    </select><input type='hidden' id='id[]' name='id[]' value=''/>";
    cell1 = row.insertCell(1);
    cell1.innerHTML = "<input type='text' name='comment[]' maxlength='50' id='comment"+ExId+"' class='span12' />";
