            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="span9" type="text" name="task_name" id="task_name" value="<?php echo $task_name; ?>" placeholder="Task Name" validate="Require" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                <input type="text" name="start_date" id="start_date" class="span9" placeholder="Start Date" value="<?php echo $db->date_formate($start_date) ?>" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea rows="3" id="task_description" name="task_description" class="input-block-level" placeholder="Task Description" ><?php echo $task_description; ?></textarea>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="radio inline">
                                <input type="checkbox" name="incom_system" id="incom_system" <?php
                            if ($incom[0] == "System") {
                            ...
                            <label class="radio inline">
                                <input type="checkbox" name="incom_email" id="incom_email" value="Email" <?php
                                       if ($incom[1] == "Email") {
                                           echo "checked='checked'";
                                       }
                            ?> />
                            ...
                            <label class="radio inline">
                                <input type="checkbox" name="incom_sms" id="incom_sms" value="SMS" <?php
                                       if ($incom[2] == "SMS") {
                                           echo "checked='checked'";
                                       }
                            ?> />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="radio inline">
                                <input type="checkbox" name="com_system" id="com_system" value="System"  <?php
                            if ($com[0] == "System") {
                                echo "checked='checked'";
                            }
                            ?>  />
                            ...
                            <label class="radio inline">
                                <input type="checkbox" name="com_email" id="com_email" value="Email" <?php
                                       if ($com[1] == "Email") {
                                           echo "checked='checked'";
                                       }
                            ?> />
                            ...
                            <label class="radio inline">
                                <input type="checkbox" name="com_sms" id="com_sms" value="SMS" <?php
                                       if ($com[2] == "SMS") {
                                           echo "checked='checked'";
                                       }
                            ?> />
