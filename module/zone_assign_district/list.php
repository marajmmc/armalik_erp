                ...
                <div id="dt_example" class="example_alt_pagination">
                    <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT
                                        count($tbl"."zone_assign_district.zone_id) as id,
                                        $tbl"."zone_info.zone_id,
                                        $tbl"."zone_info.zone_name
                                    FROM $tbl"."zone_assign_district
                                         LEFT JOIN $tbl"."zone_info ON $tbl"."zone_info.zone_id = $tbl"."zone_assign_district.zone_id
                                    WHERE $tbl"."zone_assign_district.del_status=0
                                    GROUP BY $tbl"."zone_assign_district.zone_id
