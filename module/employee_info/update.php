...
echo $mSQL = "DELETE FROM $tbl" . "zone_user_access WHERE `employee_id`='$maxID'";
...
if ($_FILES["image_url"]['name'] != "") {
    $image_url_tmp = $_POST['image_url_tmp'];
    @unlink("employee_photo/$image_url_tmp");
    ...
    $wherefield = array('employee_id' => "'$maxID'");
    $db->data_update($tbl . 'employee_basic_info', $rowfield, $wherefield);
    $db->system_event_log('', $user_id, $employee_id, $maxID, '', $tbl . 'employee_basic_info', 'Update', '');
} else {
...
//            'entry_date' => "'" . $db->ToDayDate() . "'"
//        );
//        $wherefield=array('employee_id' => "'" . $_POST["row_id"][$i] . "'");
//        $db->data_update($tbl . 'employee_education_info', $rowfield,$wherefield);
//    }
//}
