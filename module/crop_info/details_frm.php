            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="span9" type="text" disabled="" name="crop_name" id="crop_name" value="<?php echo $editrow['crop_name'] ?>" placeholder="Crop Name" validate="Require">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="crop_name">
                        ...
                        <div class="controls">
                            <input disabled class="span3" type="text" name="order_crop" id="order_crop" value="<?php echo $editrow['order_crop'];?>" placeholder="Order Crop"   />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls controls-row">
                            <select id="status" name="status" disabled="" class="span3" placeholder="Group Name">
