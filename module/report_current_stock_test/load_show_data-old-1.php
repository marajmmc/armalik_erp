...
";
            if ($db->open()) {
                ...
                while ($result_array = $db->fetchAssoc()) {
                    ...
                    $current_stock=(($result_array['total_product']-($result_array['total_delivery']+$result_array['total_bonus']+$result_array['total_access_qnty']+$result_array['total_sample_qnty']+$result_array['total_rnd_qnty']))-$result_array['total_short_qnty']);
                        ?>
