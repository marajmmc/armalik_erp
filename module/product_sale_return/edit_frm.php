                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="warehouse_id" name="warehouse_id" class="span5" placeholder="Zone" validate="Require">
                                <?php
                                echo $sql_uesr_group = "select warehouse_id as fieldkey, warehouse_name as fieldtext from $tbl" . "warehouse_info where status='Active' AND warehouse_id='$warehouse_id'";
...
//                                                echo "<option value=''>Select</option>";
                                    ...
                                    <td>
                                        <input type='text' name='price[]' id='price_<?php echo $i; ?>' value="<?php echo number_format($price[$i], 2); ?>" class='span12' readonly="" />
                                    </td>
                                    <td>
                                        <input type='text' name='quantity[]' id='quantity_<?php echo $i; ?>' class='span12' value='<?php echo number_format($approved_quantity[$i], 2); ?>' readonly="" />
                                    </td>
                                    <td>
                                        <input type='text' name='return_quantity[]' id='return_quantity_<?php echo $i; ?>' class='span12' value='0' onblur="load_product_total_price_('<?php echo $i; ?>')"/>
                                    </td>
                                    <td>
                                        <input type='text' name='total_price[]' id='total_price_<?php echo $i; ?>' class='span12' readonly="" value='<?php echo number_format($total_price[$i], 2); ?>' />
                                    </td>
                                </tr>
                                <?php
                            }
                            ...
                            <td>
                                <input type='text' name='total_return_quantity[]' id='total_return_quantity' class='span12' value='0' readonly="" />
                            </td>
                            <td>
