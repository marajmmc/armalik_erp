                    ...
                    <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT
                                    ...
                                    WHERE $tbl" . "product_purchase_order_invoice.del_status='0' AND $tbl" . "product_purchase_order_invoice.`status`='Delivery'
                                      $zone_id $territory $distributor  ".$db->get_zone_access($tbl. "product_purchase_order_invoice")."
