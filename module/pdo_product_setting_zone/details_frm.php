            ...
            <div class="form-horizontal no-margin">
                ...
                <div class="widget-body">
                    ...
                    <div class="control-group" >
                        ...
                        <div class="controls">
                            <input readonly type="text" name="special_characteristics" id="special_characteristics" value="<?php echo $edit_row['special_characteristics']?>" class="span9" placeholder="Special Characteristics"  />
                        </div>
                    </div>
                    <div class="control-group">
