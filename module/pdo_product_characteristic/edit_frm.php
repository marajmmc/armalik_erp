            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    ...
                    <div class="control-group" id="div_variety_id" style="display: <?php echo $vstatus?>">
                        ...
                        <div class="controls">
                            <select id="variety_id" name="variety_id" class="span5" placeholder="Select Product" validate="Require" onchange="load_variety_txt(); load_company_name()">
                                <?php
                                echo "<option value=''>Select</option>";
                    ...
                    <div class="control-group" id="div_variety_txt" style="display: <?php echo $vtstatus?>;">
                        ...
                        <div class="controls">
                            <select name="variety_name_txt" id="variety_name_txt" class="span5"  onchange="load_company_name()">
                                <?php
                                echo "<option value=''>Select</option>";
                                 $sql_uesr_group = "
                                                    select
...
";
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="sales_quantity" id="sales_quantity" value="<?php echo $editrow['sales_quantity']?>" class="span2" placeholder="Sales Quantity" validate="Require" />
                            <span class="help-inline">
                                Kg.
                            </span>
                        </div>
...
elseif($editrow['product_category']=="Checked Variety")
{
    ?>
    <script>
        $(document).ready(function ()
