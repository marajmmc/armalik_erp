                            ...
                            <tbody>
                                ...
                                for ($i = 0; $i < $count; $i++) {
                                    ...
                                    echo "<tr class='$rowcolor'>
                                            <td>
                                                <input type='text' name='location[]' value='$location[$i]' id='location_$i' class='span12'/>        
                                                <input type='hidden' id='id[]' name='id[]' value='$id[$i]'/>
                                            </td>
                                            <td>
                                                <input type='text' name='visit_purpose[]' value='$visit_purpose[$i]' id='visit_purpose_$i' class='span12'/>        
                                            </td>
                                            <td>
                                                <div class='input-append'>
                                                    <input type='text' name='plan_date[]' maxlength='50' id='plan_date_$i' class='span9' value='$plan_date[$i]'/>
    <                                               <span class='add-on' id='calcbtn_plan_date_$i'>
                                ...
                                <script>    
                                    ...
                                    cal.manageFields("calcbtn_plan_date_"+DID, "plan_date_"+DID, "%d-%m-%Y");
                                    //                        
                                </script>
                                <?php
                                ++$DID;
