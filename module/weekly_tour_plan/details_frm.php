...
<!--                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select disabled="" id="territory_id" name="territory_id" class="span5" placeholder="Territory" onchange="load_distributor_fnc()" >
                                <option value="">Select</option>
                                <?php
                                    ...
                                    echo "<tr class='$rowcolor'>
                                            ...
                                            <td>
                                                <div class='input-append'>
                                                    <input disabled='' type='text' name='plan_date[]' maxlength='50' id='plan_date_$i' class='span9' value='$plan_date[$i]'/>
