            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                <input type="text" name="payment_date" id="payment_date" class="span9" placeholder="Date of invoice" value="<?php echo $db->date_formate($editrow['payment_date']) ?>"  />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="zone_id" name="zone_id" class="span5" placeholder="Zone" validate="Require">
                                ...
                                <?php
                                $sql_uesr_group = "select zone_id as fieldkey, zone_name as fieldtext from $tbl" . "zone_info WHERE status='Active' AND del_status='0' AND zone_id='".$editrow['zone_id']."' " . $db->get_zone_access($tbl . "zone_info") . " ";
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="territory_id" name="territory_id" class="span5" placeholder="Territory" validate="Require">
                                <option value="">Select</option>
                                <?php
                                $sql_uesr_group = "select territory_id as fieldkey, territory_name as fieldtext from $tbl" . "territory_info WHERE status='Active' AND del_status='0' AND zone_id='" . $editrow['zone_id'] . "' AND  territory_id='".$editrow['territory_id']."'";
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="payment_type" name="payment_type" class="span5" placeholder="payment type" validate="Require" onchange="payment_type_fnc()">
                                <option value="">Select</option>
                                <option value="Cash" <?php if($editrow['payment_type']=="Cash"){echo "selected='selected'";}?> >Cash</option>
                                <option value="Pay Order" <?php if($editrow['payment_type']=="Pay Order"){echo "selected='selected'";}?> >Pay Order</option>
                                <option value="Cheque" <?php if($editrow['payment_type']=="Cheque"){echo "selected='selected'";}?> >Cheque</option>
                                <option value="TT" <?php if($editrow['payment_type']=="TT"){echo "selected='selected'";}?> >TT</option>
                                <option value="DD" <?php if($editrow['payment_type']=="DD"){echo "selected='selected'";}?> >DD</option>
                                <option value="Online Payment" <?php if($editrow['payment_type']=="Online Payment"){echo "selected='selected'";}?> >Online Payment</option>
                            </select>
                            <span class="help-inline">
                                *
                            </span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="span3" type="text" name="amount" id="amount" placeholder="Amount" value="<?php echo $editrow['amount']?>" onkeypress="return numbersOnly(event)" validate="Require">
                            <span class="help-inline">
                                *
                            </span>
                        </div>
                    ...
                    <div class="control-group" id="div_cheque_no" style="display: none;">
                        ...
                        <div class="controls">
                            <input class="span5" type="text" name="cheque_no" id="cheque_no" value="<?php echo $editrow['cheque_no']?>" placeholder="Payment Number" >
                        </div>
                    </div>
                    <div class="control-group">
