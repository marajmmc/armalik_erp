                    ...
                    <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT
                                    ...
                                    WHERE $tbl" . "distributor_add_payment.status='Payment' AND $tbl" . "distributor_add_payment.del_status='0' $zone_id $territory $distributor  ".$db->get_zone_access($tbl. "distributor_add_payment")." 
                            ...
                            if ($db->open()) {
                                ...
                                while ($result_array = $db->fetchAssoc()) {
                                    ...
                                    ?>
                                    <tr class="<?php echo $rowcolor ?> pointer" id="tr_id<?php echo $i; ?>" onclick="get_rowID('<?php echo $result_array["payment_id"] ?>', '<?php echo $i; ?>')" ondblclick="details_form();">
                                        <td>
                                            <?php echo $i; ?>
                                        </td>
