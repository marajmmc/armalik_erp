            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="varriety_id" name="varriety_id" class="span5" placeholder="Select Variety" validate="Require" >
                                <option value="">Select</option>
                                <?php
                                echo $sql_uesr_group = "select varriety_id as fieldkey, varriety_name as fieldtext from $tbl" . "varriety_info where status='Active' AND crop_id='" . $editrow['crop_id'] . "' AND product_type_id='".$editrow['product_type_id']."'";
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="span9" type="text" name="location" id="location" value="<?php echo $editrow['location']; ?>" placeholder="Location" validate="Require">
                            <span class="help-inline">
                                *
                            </span>
                        </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="farmer_name" id="farmer_name" value="<?php echo $editrow['farmer_name']; ?>" class="span9" placeholder="Farmer Name"  validate="Require" />
                        </div>
                        <span class="help-inline">
                            *
                        </span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="phone_number" id="phone_number" value="<?php echo $editrow['phone_number']; ?>" class="span9" placeholder="Farmer Phone Number"  validate="Mobile" maxlength="11" onkeypress="return numbersOnly(event)"/>
                        </div>
                        <span class="help-inline">
                            *
                        </span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                <input type="text" name="picture_date" id="picture_date" value="<?php echo $db->date_formate($editrow['picture_date']); ?>" class="span9" placeholder="Picture Date"  />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <?php } ?>
                            <input type="file" name="photo" id="photo" class="span9" placeholder="Product Photo" onchange="readURL(this)" />
                        </div>
                    </div>
                </div>
            </div>
