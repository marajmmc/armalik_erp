...
if (@$_FILES["photo"]['name'] != "") {
    ...
    $wherefield = array('photo_gallery_id' => "'$maxID'");
    $db->data_update($tbl . 'product_photo_gallery', $rowfield, $wherefield);
    $db->system_event_log('', $user_id, $employee_id, $maxID, '', $tbl . 'product_photo_gallery', 'Update', '');
} else {
    $rowfield = array(
