            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="bank_id" name="bank_id" disabled='' class="span5" placeholder="Bank Name">
                                ...
                                if ($db->open()) {
                                    ...
                                    while ($result_array = $db->fetchAssoc()) {
                                        ...
                                        echo "<tr class='$rowcolor'>
                                            <td>
                                                <input type='text' disabled='' name='branch_name[]' value='$result_array[branch_name]' maxlength='50' id='branch_name_$i' class='span12'/>        
