            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select disabled="" id="product_type_id" name="product_type_id" class="span5" placeholder="Product Type" onchange="load_pdo_variety()">
                                <?php
                                echo "<option value=''>Select</option>";
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select disabled="" id="pdo_id" name="pdo_id" class="span5" placeholder="Select Product" validate="Require">
                                <?php
                                echo "<option value=''>Select</option>";
                                $sql_uesr_group = "
                                                select
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                <input disabled="" type="text" name="upload_date" id="upload_date" value="<?php echo $db->date_formate($editrow['upload_date']); ?>" class="span9" placeholder="Date"  />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="mainbox" onclick="product_image_info('<?php echo $editrow['upload_id'] ?>');">
                                <div class="subbox" style="width: 50%">
                                    <div class="imgbox">
                                        <img src="../../system_images/pdo_upload_image/<?php echo $editrow['image_url']; ?>" title="<?php echo $editrow['description']; ?>" />
                                    </div>
                                </div>
                            </div>
