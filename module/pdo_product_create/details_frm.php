            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select disabled="" id="product_type_id" name="product_type_id" class="span5" placeholder="Product Type">
                                <?php
                                echo "<option value=''>Select</option>";
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input disabled="" class="span9" type="text" name="pdo_name" id="pdo_name" value="<?php echo $editrow['pdo_name'] ?>" placeholder="Product Name" validate="Require">
                            <span class="help-inline">
                                *
                            </span>
                        </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            ?>
                            <input disabled="" type="checkbox" name="pdo_type" id="pdo_type" <?php echo $checked;?> value="Checked Variety" />
                        </div>
                    </div>
                    <div class="control-group">
