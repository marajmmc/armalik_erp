...
$variety_id=$editrow['varriety_id'];
$crop_id=$editrow['crop_id'];
$product_type_id=$editrow['product_type_id'];
?>
<div class="row-fluid">
    <div class="span12">
            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="span9" type="text" name="varriety_name" id="varriety_name" value="<?php echo $editrow['varriety_name'] ?>" placeholder="Variety Name" validate="Require">
                            <span class="help-inline">
                                *
                            </span>
                        </div>
                    ...
                    <div class="control-group competitor" style='display:<?php if($editrow['type']!=1){echo "none";}?>'>
                        ...
                        <div class="controls">
                            <input class="span9" type="text" name="company_name" id="company_name" value="<?php echo $editrow['company_name'];?>" placeholder="Company Name">
                            <span class="help-inline">
                                *
                            </span>
                        </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="span3" type="text" name="order_variety" id="order_variety" value="<?php echo $editrow['order_variety'];?>" placeholder="Order Variety" onkeypress="return numbersOnly(event)" onblur="Existin_data(this, 'Edit', '<?php echo $variety_id?>','<?php echo $crop_id?>','<?php echo $product_type_id?>')" />
                            <span class="help-inline">
                                *
                            </span>
                        </div>
