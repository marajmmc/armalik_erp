                ...
                <div class="form-horizontal no-margin">
                    <div class="widget-body">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="span5" type="text" name="user_name" id="user_name" placeholder="User Name" validate="Require" value="<?php echo $result_array['user_name']; ?>" />
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls controls-row">
                                <select id="employee_id" name="employee_id" class="span5" validate="Require" placeholder="Employee Name" onchange="load_employee_name()">
                                    <option value="">Select</option>
                                    <?php
                                    if ($result_array['user_level'] == "Distributor") {
