...
<div id="PrintArea" style="background-color: white;" >
    ...
    $sqli = "SELECT
        ...
        WHERE $tbl" . "product_purchase_order_challan.challan_id='" . $_POST['rowID'] . "' AND 
...
//    if ($rowi['challan_id'] == "") {
//        echo "<div style='text-align: center; color: red;'><b>Challan Not Receipt! Please Try Again.</b></div>";
//    } else {
    ?>
