                                ...
                                <thead>
                                    ...
                                    <?php
                                     $sqlbonus = "SELECT
                                                ...
                                                SUM(($tbl" . "product_pack_size.pack_size_name*$tbl" . "product_stock.current_stock_qunatity)/1000) as current_stock_qunatity
                                            FROM
                                            ...
                                            WHERE
                                                ...
                                                $tbl" . "product_purchase_order_bonus.del_status='0'
                                    ";
                                    if ($db->open()) {
                                        $i=0;
