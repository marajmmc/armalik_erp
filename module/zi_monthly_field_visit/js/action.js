...
function load_farmers()
{
    $("#farmers_id").html('');
    $.post("../../libraries/ajax_load_file/load_farmers.php",
    {
        territory_id:$("#territory_id").val(), district_id: $("#district_id").val(), upazilla_id:$("#upazilla_id").val(), crop_id: $("#crop_id").val(), type_id: $("#type_id").val(), variety_id: $("#variety_id").val()
    },
