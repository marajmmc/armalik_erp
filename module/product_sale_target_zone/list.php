                        ...
                        <tbody>
                            ...
                            $sql = "SELECT
                                        ...
                                        FROM
                                            ...
                                            LEFT JOIN $tbl" . "zone_user_access ON $tbl" . "zone_user_access.zone_id = $tbl" . "zone_info.zone_id
                                            LEFT JOIN $tbl" . "division_info ON $tbl" . "division_info.division_id = $tbl" . "zone_user_access.division_id
                                            LEFT JOIN $tbl" . "year ON $tbl" . "year.year_id = $tbl" . "product_sale_target.year_id
                                        WHERE
                                            $tbl" . "product_sale_target.del_status='0' AND 
                                            $tbl" . "product_sale_target.channel='Zone'  
                                            " . $db->get_zone_access($tbl . "product_sale_target") . "
