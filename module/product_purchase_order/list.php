                    ...
                    <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT
                                    ...
                                    WHERE
                                        $tbl" . "product_purchase_order_request.del_status='0'  AND
                                        $tbl" . "product_purchase_order_request.status='Edit_Ready'
                            ...
                            if ($db->open()) {
                                ...
                                while ($result_array = $db->fetchAssoc()) {
                                    ...
                                    <tr class="<?php echo $rowcolor ?> pointer" id="tr_id<?php echo $i; ?>" onclick="get_rowID('<?php echo $result_array["purchase_order_id"] ?>', '<?php echo $i; ?>')" ondblclick="details_form();">
                                        ...
                                        <td>
                                            <a class='btn btn-warning' data-original-title='' onclick="po_send('<?php echo $i; ?>','<?php echo $result_array['purchase_order_id']; ?>')">
                                                Send PO
                                            </a>
                                        </td>
                                    </tr>
