                ...
                <div class="form-horizontal no-margin">
                    <div class="widget-body">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input disabled="" class="span5" type="text" name="user_name" id="user_name" placeholder="User Name" validate="Require" value="<?php echo $result_array['user_name']; ?>" />
                        ...
                        <div class="control-group">
                            <label class="control-label" for="user_old_pass">
                                Old Password
                            </label>
                            <div class="controls">
                                <input type="password" name="user_old_pass" id="user_old_pass" onblur="load_old_password(this)" class="span5" placeholder="Old Password"  validate="Require" autocomplete="off" title="Password must be 6 digit And minimum one Uppercase Word, one Lowercase word and one numeric."/>
                                <span class="help-inline">
                                    *
                                </span>
                            </div>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="user_new_pass">
                                New Password
                            </label>
                            <div class="controls">
                                <input type="password" name="user_new_pass" id="user_new_pass" class="span5" placeholder="New Password"  validate="Require" autocomplete="off" title="Password must be 6 digit And minimum one Uppercase Word, one Lowercase word and one numeric."/>
                                <span class="help-inline">
                                    *
                                </span>
                            </div>
...
<!--                        <div class="control-group">
                            ...
                            <div class="controls controls-row">
                                <select disabled="" id="user_group_id" name="user_group_id" class="span5" validate="Require" placeholder="Group Name">
...
<!--                        <div class="control-group">
                            ...
                            <div class="controls controls-row">
                                <select disabled="" id="user_level" name="user_level" class="span5" onchange="load_user_type();load_employee_fnc()" validate="Require" placeholder="User Type">
                                    <option value="">Select</option>
...
//                                        }
                        ...
                        <div class="control-group" id="div_warehouse_id" style="display: none;">
                            ...
                            <div class="controls">
                                <select disabled="" id="warehouse_id" name="warehouse_id" class="span5" placeholder="Warehouse" onchange="load_employee_fnc()">
                                    <option value="">Select</option>
                                    <?php
...
//                                    echo $db->SelectList($sql_uesr_group, $result_array['warehouse_id']);
                        ...
                        <div class="control-group" id="div_zone_id" style="display: none;">
                            ...
                            <div class="controls">
                                <select disabled="" id="zone_id" name="zone_id" class="span5" placeholder="Zone" onchange="load_territory_fnc();load_employee_fnc()">
                                    <option value="">Select</option>
                                    <?php
...
//                                    echo $db->SelectList($sql_uesr_group, $result_array['zone_id']);
                        ...
                        <div class="control-group" id="div_territory_id" style="display: none;">
                            ...
                            <div class="controls">
                                <select disabled="" id="territory_id" name="territory_id" class="span5" placeholder="Territory"  onchange="load_distributor_fnc();load_employee_fnc()">
                                    <option value="">Select</option>
                                    <?php
...
//                                    echo $db->SelectList($sql_uesr_group, $result_array['territory_id']);
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls controls-row">
                                <select disabled="" id="employee_id" name="employee_id" class="span5" validate="Require" placeholder="Employee Name" onchange="load_employee_name()">
                                    <option value="">Select</option>
                                    <?php
//                                    if ($result_array['user_level'] == "Distributor") {
...
//                                    ?>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls controls-row">
                                <select id="user_status" name="user_status" class="span5" validate="Require"placeholder="User Status">
                                    <option value="">Select</option>
