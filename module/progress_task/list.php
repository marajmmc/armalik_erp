                        ...
                        <tbody>
                            <?php
                             $sql = "SELECT
                                    ...
                                    FROM
                                        $tbl" . "task_management
                                        LEFT JOIN $tbl" . "user_login ON $tbl" . "user_login.user_id = $tbl" . "task_management.entry_by
                                        LEFT JOIN $tbl" . "employee_basic_info ON $tbl" . "employee_basic_info.employee_id = $tbl" . "user_login.employee_id
                                    WHERE $tbl" . "task_management.del_status='0' AND $tbl" . "task_management.employee_id='$employee_id'
                                    GROUP BY
                                        $tbl" . "task_management.task_plan_id
                            ";
