            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="span9" type="text" name="designation_title_en" id="designation_title_en" value="<?php echo $editrow['designation_title_en'] ?>" placeholder="Designation Name (EN)" validate="Require">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="span9" type="text" name="designation_title_bn" id="designation_title_bn" value="<?php echo $editrow['designation_title_bn'] ?>" placeholder="Designation Name (BN)" >
                        </div>
                    </div>
                    <div class="control-group">
