        ...
        <div class="widget span">
            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="current_credit_limit">
                            Credit Limit 
                        </label>
                        <div class="controls">
                            <input readonly="" class="span3" type="text" name="all_credit_limit" id="all_credit_limit" placeholder="Current Credit Limit" onkeypress="return numbersOnly(event)" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input readonly="" class="span3" type="text" name="credit_limit_status" id="credit_limit_status" placeholder="Credit Limit Status" onkeypress="return numbersOnly(event)" />
                        </div>
                    </div>
<!--                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input disabled="" class="span3" type="text" name="credit_limit" id="credit_limit" value="<?php echo $editrow['credit_limit'] ?>" placeholder="Credit Limit" onkeypress="return numbersOnly(event)" />
                        </div>
                    </div>-->
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input disabled="" class="span9" type="text" name="check_no" id="check_no" value="<?php echo $editrow['check_no'] ?>" placeholder="Cheque No" >
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input disabled="" class="span9" type="text" name="amount" id="amount" value="<?php echo $editrow['amount'] ?>" placeholder="Amount" onkeypress="return numbersOnly(event)" />
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select disabled="" id="bank_id" name="bank_id" class="span5" placeholder="Bank Name" onchange="load_branch_name()">
                                <option value="">Select</option>
                                <?php
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select disabled="" id="branch_id" name="branch_id" class="span5" placeholder="Branch Name">
                                <option value="">Select</option>
                                <?php
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea disabled="" class="span9" name="comment" id="comment" placeholder="Comment" ><?php echo $editrow['comment'] ?></textarea>
                        </div>
                    </div>
                    <div class="control-group">
