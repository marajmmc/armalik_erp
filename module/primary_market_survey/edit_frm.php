...
";
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="crop_master_id" name="crop_master_id" class="span5" placeholder="Select Crop" validate="Require" onchange="load_product_type()">
                                <option value="">Select</option>
                                <?php
                                $sql_uesr_group = "select crop_id as fieldkey, crop_name as fieldtext from $tbl" . "crop_info where status='Active' AND del_status='0'  order by order_crop";
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="product_master_type_id" name="product_master_type_id" class="span5" placeholder="Product Type" onchange="load_product_list_edit()" validate="Require">
                                <option value="">Select</option>
                                <?php
