...
if($_SESSION['user_level']=="Marketing"){
    $employee_id="";
}else{
    $employee_id="AND $tbl" . "weekly_tour_plan.employee_id='$employee_id'";
}
?>
                        ...
                        <tbody>
                            <?php
                             $sql = "SELECT
                                        ...
                                        WHERE $tbl" . "weekly_tour_plan.del_status='0' $employee_id   ".$db->get_zone_access($tbl. "weekly_tour_plan")." 
