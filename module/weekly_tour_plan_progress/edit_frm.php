...
<!--                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select disabled="" id="territory_id" name="territory_id" class="span5" placeholder="Territory" onchange="load_distributor_fnc()"  validate="Require">
                                <option value="">Select</option>
                                //<?php
//                                $sql_uesr_group = "select territory_id as fieldkey, territory_name as fieldtext from $tbl" . "territory_info WHERE status='Active' AND del_status='0' AND zone_id='$zone_id' AND territory_id='$territory_id'";
                            ...
                            <tbody>
                                ...
                                for ($i = 0; $i < $count; $i++) {
                                    ...
                                    echo "<tr class='$rowcolor'>
                                            ...
                                            <td>    
                                                <textarea rows='8' name='purpose[]' class='span12'>".preg_replace('/<br\\s*?\/??>/i', '',$purpose[$i])."</textarea> 
                                            </td>
                                        <tr>";
