        ...
        <div class="widget span">
            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                <input type="text" name="sale_date" id="sale_date" class="span9" placeholder="Date of Sale" value="<?php echo $db->date_formate($db->ToDayDate()) ?>"  />
                    ...
                    <div class="controls controls-row" id="div_add_more">
...
<!--                        <table class="table table-condensed table-striped table-bordered table-hover no-margin" id="TaskTable">
                            <tbody>
                                <tr>
                                    ...
                                    <th style="width:10%">&nbsp;</th>
                                    <th style="width:10%">
                                        <input readonly="" type='text' name='ground_price' id='ground_price' class='span12' />
                                    </th>
                                    <th style="width:10%">
                                        <input readonly="" type='text' name='ground_total_quantity' id='ground_total_quantity' class='span12' />
                                    </th>
                                    <th style="width:10%">
                                        <input readonly="" type='text' name='ground_total_stock' id='ground_total_stock' class='span12' />
                                    </th>
                                    <th style="width:10%">
                                        <input readonly="" type='text' name='ground_total_price' id='ground_total_price' class='span12' />
                                    </th>
                                    <th  style="width:5%">
                                        &nbsp;
                                    </th>
...
?>\n\
    ...
    <option value=''>Select</option></select>";
                ...
                cell1.innerHTML = "<select id='pack_size"+ExId+"' name='pack_size[]' class='span12' placeholder='Zone' onchange='load_product_price_fnc("+ExId+"); load_product_stock_fnc("+ExId+");'>\n\
    <option value=''>Select</option></select>";
                cell1.style.cursor="default";
        
                cell1 = row.insertCell(4);
                cell1.innerHTML = "<input type='text' name='purchase_price[]' maxlength='50' id='purchase_price"+ExId+"' class='span12' "+ElmReadonly+" />";
                cell1.style.cursor="default";
                
                cell1 = row.insertCell(5);
                cell1.innerHTML = "<input type='text' name='price[]' maxlength='50' id='price"+ExId+"' class='span12' />";
                cell1.style.cursor="default";
                ...
                cell1.innerHTML = "<input type='text' name='current_quantity[]' maxlength='50' id='current_quantity"+ExId+"' class='span12' value='0'  "+ElmReadonly+" />";
                cell1.style.cursor="default";
...
<script>
    $(document).ready(function(){
//        setTimeout(function(){load_dealer_fnc()},3000); 
    });
    ...
    cal.manageFields("calcbtn_sale_date", "sale_date", "%d-%m-%Y");
