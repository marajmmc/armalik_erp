            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input disabled="" class="span3" type="text" name="dealer_name" id="dealer_name" value="<?php echo $editrow['dealer_name'] ?>" placeholder="Dealer Name" >
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input disabled="" class="span9" type="text" name="owner_name" id="owner_name" value="<?php echo $editrow['owner_name'] ?>" placeholder="Owner Name" >
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input disabled="" class="span9" type="text" name="market_name" id="market_name" value="<?php echo $editrow['market_name'] ?>" placeholder="Market Name" >
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input disabled="" class="span3" type="text" name="phone_no" id="phone_no" value="<?php echo $editrow['phone_no'] ?>" placeholder="Phone" validate="Mobile" maxlength="11" onkeypress="return numbersOnly(event)" >
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                ...
                                <input disabled="" type="text" name="email" id="email" value="<?php echo $editrow['email'] ?>" class="span12" placeholder="Email" validate="Email" />
                            </div>
                        </div>
                    </div>
                    <div class="control-group">
