            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="start_date" id="start_date" class="span5" value="<?php echo $db->date_formate($editRow['start_date'])?>"/>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="end_date" id="end_date" class="span5" value="<?php echo $db->date_formate($editRow['end_date'])?>" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea name="distributor_others" class="span6"><?php echo $editRow['distributor_others'];?></textarea>
                        </div>
                    </div>
