            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select disabled id="employee_id" name="employee_id" class="span5" placeholder="Select Farmer" validate="Require">
                                <?php
                    ...
                    <div class="control-group">
                        <div id="div_pdo_variety">
                            <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                                ...
                                $crop_id="AND crop_id='".$editrow['crop_id']."'";
                                $product_type_id="AND product_type_id='".$editrow['product_type_id']."'";
                                ...
                                if ($db->open()) {
                                    ...
                                    while ($result_array = $db->fetchAssoc()) {
                                        ...
                                        echo "<tr class='row_hover' $rowcolor>
                                                    <td align='left'>
                                                        <input disabled type='checkbox' $acs_check name='$result_array[pdo_id]' id='$result_array[pdo_id]' value='$result_array[pdo_id]'  />
