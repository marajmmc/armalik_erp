            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="zone_id" name="zone_id" class="span5" placeholder="Select Farmer" validate="Require">
                                <?php
                            ...
                            if ($dbrow->open()) {
                                ...
                                while ($result_array = $dbrow->fetchAssoc()) {
                                    ...
                                    echo "<tr class='row_hover' $rowcolor  $bg_color>
                                                    <td align='left'>
                                                        <input type='checkbox' $acs_check  name='$result_array[zillaid]' id='$result_array[zillaid]' value='$result_array[zillaid]'  />
