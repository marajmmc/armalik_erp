            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body span6">
                    <div class="control-group">
                        <label class="control-label" for="division_name">
                            Division Name 
                        </label>
                        <div class="controls">
                            <input class="span9" type="text" name="division_name" id="division_name" value="<?php echo $editrow['division_name'] ?>" placeholder="Division Name" validate="Require">
