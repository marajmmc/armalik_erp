...
$db = new Database();
$tbl = _DB_PREFIX;
$editrow = $db->single_data($tbl . "division_info", "*", "division_id", $_POST['rowID']);
?>
<div class="row-fluid">
    <div class="span12">
            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body span6">
                    <div class="control-group">
                        <label class="control-label" for="division_name_en">
                            Division Name
                        </label>
                        <div class="controls">
                            <input class="span9" type="text" disabled="" name="division_name_en" id="division_name_en" value="<?php echo $editrow['division_name'] ?>" placeholder="division Name (EN)" validate="Require">
