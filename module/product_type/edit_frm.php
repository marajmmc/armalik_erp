            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="span9" type="text" name="product_type" id="product_type" value="<?php echo $editrow['product_type']?>" placeholder="Product Type" validate="Require">
                            <span class="help-inline">
                                *
                            </span>
                        </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="span3" type="text" name="order_type" id="order_type" value="<?php echo $editrow['order_type'];?>" placeholder="Order "  onblur="Existin_data(this, 'Edit', '<?php echo $product_type_id;?>', '<?php echo $crop_id;?>')" validate="Require" onkeypress="return numbersOnly(event)" />
                            <span class="help-inline">
                                *
                            </span>
                        </div>
