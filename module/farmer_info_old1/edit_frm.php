            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="span3" type="text" name="contact_no" id="contact_no" value="<?php echo $editrow['contact_no'] ?>" placeholder="Mobile No" validate="Mobile" maxlength="11" onkeypress="return numbersOnly(event)" >
                        </div>
                    </div>
                    <div class="control-group">
