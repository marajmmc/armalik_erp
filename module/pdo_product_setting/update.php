...
$wherefield = array('prodcut_characteristic_id' => "'$maxID'");
$db->data_update($tbl . 'pdo_product_characteristic_setting', $rowfield, $wherefield);
$db->system_event_log('', $user_id, $ei_id, $maxID, '', $tbl . 'pdo_product_characteristic_setting', 'Update', '');
...
FROM `ait_zone_info`
WHERE ait_zone_info.status='Active'
AND ait_zone_info.del_status=0
AND ait_zone_info.zone_id NOT IN (SELECT zone_id FROM $tbl"."pdo_product_characteristic_setting_zone WHERE prodcut_characteristic_id='$maxID')
