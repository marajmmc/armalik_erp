...
<!--                        </label>-->
<!--                        <div class="controls">-->
<!--                            <select disabled id="zone_id" name="zone_id" class="span5" placeholder="Zone" onchange="load_territory_fnc()">-->
...
<!--                    </div>-->
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select disabled id="hybrid" name="hybrid" class="span5" placeholder="" validate="Require">
                                <option value="">Select</option>
                    ...
                    <div class="control-group" id="div_variety_txt" style="display: <?php echo $vtstatus?>;">
                        ...
                        <div class="controls">
                            <input disabled type="text" name="variety_name_txt" id="variety_name_txt" value="<?php echo $editrow['variety_name_txt']?>" class="span5" placeholder="Variety Name"  />
                        </div>
                    </div>
                    <div class="control-group" id="div_company_name" style="display: <?php echo $vtstatus?>;">
                        ...
                        <div class="controls">
                            <input disabled type="text" name="company_name" id="company_name" value="<?php echo $editrow['company_name']?>" class="span5" placeholder="Company Name"  />
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <?php
                            if($editrow['cultivation_period_start']!="")
                            {
                                $date1=strtotime($editrow['cultivation_period_start']);
                                $cultivation_period_start= date('d M', $date1);
                            }
                            else
                            {
                                $cultivation_period_start='';
                            }
                            if($editrow['cultivation_period_end'])
                            {
                                $date2=strtotime($editrow['cultivation_period_end']);
                                $cultivation_period_end= date('d M', $date2);
                            }
                            else
                            {
                                $cultivation_period_end='';
                            }
                            ?>
                            <div class="input-append">
                                <input disabled type="text" name="cultivation_period_start" id="cultivation_period_start" value="<?php echo $cultivation_period_start?>" class="span9" placeholder="Start Date"  />
                                <span class="add-on" id="calcbtn_cultivation_period_start">
                                    <i class="icon-calendar"></i>
                                </span>
                            </div>
                            <div class="input-append">
                                <input disabled type="text" name="cultivation_period_end" id="cultivation_period_end" value="<?php echo $cultivation_period_end?>" class="span9" placeholder="End Date"  />
                    ...
                    <div class="control-group" >
                        ...
                        <div class="controls">
                            <input disabled type="text" name="special_characteristics" id="special_characteristics" value="<?php echo $editrow['special_characteristics']?>" class="span9" placeholder="Special Characteristics"  />
                        </div>
                    </div>
                    ...
                    <div class="control-group" >
                        ...
                        <div class="controls">
                            <textarea disabled name="remarks" id="remarks" class="span9" placeholder="Remarks"><?php echo $editrow['remarks']?></textarea>
                        </div>
                    </div>
                    <div class="control-group">
