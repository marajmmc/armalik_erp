            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="division_id" name="division_id" class="span5" placeholder="Division" onchange="load_zone()" validate="Require">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="zone_id" name="zone_id" class="span5" placeholder="Zone" onchange="load_district(); load_territory_fnc()" validate="Require">
                                <option value="">Select</option>
                                <?php
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="territory_id" name="territory_id" class="span5" placeholder="Territory" validate="Require">
                                <?php
                                $sql_uesr_group = "select territory_id as fieldkey, territory_name as fieldtext from $tbl" . "territory_info where status='Active' AND del_status='0'  AND zone_id='".$editrow['zone_id']."' ORDER BY territory_name";
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="upazilla_id" name="upazilla_id" class="span5" placeholder="Customer" validate="Require">
                                <?php
                                echo "<option value=''>Select</option>";
...
<!--                    </div>-->
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="span9" type="text" name="farmer_name" id="farmer_name" value="<?php echo $editrow['farmer_name'] ?>" placeholder="Farmer Name" >
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="span9" type="text" name="father_name" id="father_name" value="<?php echo $editrow['father_name'] ?>" placeholder="Father Name" >
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="span3" type="text" name="contact_no" id="contact_no" value="<?php echo $editrow['contact_no'] ?>" placeholder="Contact No" validate="Mobile" maxlength="11" onkeypress="return numbersOnly(event)" >
                        </div>
                    </div>
                    <div class="control-group">
