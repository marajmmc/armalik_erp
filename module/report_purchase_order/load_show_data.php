...
";
        if ($dbM->open()) {
            ...
            while ($rowM = $dbM->fetchAssoc($resultM)) {
                $po_id = $rowM['purchase_order_id'];
                $invoice_id = $rowM['invoice_id'];
                ?>
                <thead>
                    <tr>
                        <th style="width:5%">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT
                                ...
                                WHERE
                                    ...
                                    $tbl" . "product_purchase_order_invoice.purchase_order_id='$po_id'
                                    " . $db->get_zone_access($tbl . "product_purchase_order_invoice") . "
";
                        if ($db->open()) {
                            $result = $db->query($sql);
...
//                                        }
                        ...
                        WHERE $tbl" . "product_purchase_order_bonus.del_status='0' AND
