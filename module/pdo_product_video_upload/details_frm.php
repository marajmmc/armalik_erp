            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select disabled id="arm_variety_id" name="arm_variety_id" class="span5" placeholder="Product Type" validate="Require">
                                <?php
                                echo "<option value=''>Select</option>";
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select disabled id="check_variety_id" name="check_variety_id" class="span5" placeholder="" validate="Require">
                                <?php
                                echo "<option value=''>Select</option>";
