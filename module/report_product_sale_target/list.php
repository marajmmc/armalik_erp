                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-append">
                                        <input type="text" name="from_date" id="from_date" class="span9" placeholder="From Date" value="<?php echo date('Y')  ?>"  />
...
<!--                                <td>
                                    <div class="input-append">
                                        <input type="text" name="to_date" id="to_date" class="span9" placeholder="From Date" value="<?php echo date('Y')  ?>"  />
...
<script>
    ...
    cal.manageFields("calcbtn_from_date", "from_date", "%Y");
//    cal.manageFields("calcbtn_to_date", "to_date", "%Y");
