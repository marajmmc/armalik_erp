    ...
    <table class="table table-condensed table-striped table-hover table-bordered pull-left report" id="data-table">
        ...
        <tbody>
            ...
            $sql = "SELECT
                        ...
                        FROM $tbl" . "distributor_product_sale 
                        ...
                        WHERE $tbl" . "distributor_product_sale.del_status='0' $crop_id $product_type_id $varriety_id $pack_size $zone_id $territory_id $distributor_id $between
                        GROUP BY
                            ...
                            $tbl" . "distributor_product_sale.product_type_id,
...
";
            if ($db->open()) {
                ...
                while ($result_array = $db->fetchAssoc()) {
                    ...
                    $kg = ($result_array['pack_size_name'] * $result_array['quantity']) / 1000;
                    $tkg = $tkg + $kg;
                    ?>
        ...
        <tfoot>
            <tr>
                ...
                <td style="text-align: right;"><?php echo $tkg ?></td>
            </tr>
        </tfoot>
        </tbody>
    </table>
