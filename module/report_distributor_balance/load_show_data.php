    ...
    <table class="table table-condensed table-striped table-hover table-bordered pull-left report" id="data-table">
        ...
        <tbody>
            ...
            $sql = "SELECT
                    ...
                    WHERE $tbl" . "distributor_info.status='Active' AND $tbl" . "distributor_balance.del_status='0'
                        $zone_id $territory_id $distributor_id " . $db->get_zone_access($tbl . "distributor_info") . "
        ...
        <tfoot>
            <tr>
                ...
                <td style="text-align: right;"><?php echo number_format($CL, 2) ?></td>
                <td style="text-align: right;"><?php echo number_format($PA, 2) ?></td>
                <td style="text-align: right;"><?php echo number_format($DA, 2); ?></td>
