            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="zone_id" name="zone_id" disabled='' class="span5" placeholder="Zone">
                                ...
                                if ($db->open()) {
                                    ...
                                    while ($result_array = $db->fetchAssoc()) {
                                        ...
                                        echo "<tr class='$rowcolor'>
                                            <td>
                                                <input type='text'  disabled='' name='territory_name[]' value='$result_array[territory_name]' maxlength='50' id='territory_name_$i' class='span12'/>        
