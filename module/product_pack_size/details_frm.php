...
$db = new Database();
$tbl = _DB_PREFIX;
$editrow = $db->single_data($tbl . "product_pack_size", "*", "pack_size_id", $_POST['rowID']);
?>
<div class="row-fluid">
    <div class="span12">
            ...
            <div class="form-horizontal no-margin">
                <div class="widget-body">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input disabled="" class="span9" type="text" name="pack_size_name" id="pack_size_name" value="<?php echo $editrow['pack_size_name'] ?>" placeholder="Pack Size(gm)" validate="Require">
