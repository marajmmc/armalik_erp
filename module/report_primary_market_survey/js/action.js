...
{
    $('#div_show_rpt').html('');
    if($('#zone_id').val()=="" || $('#territory_id').val()=="" || $('#district_id').val()=="" || $("#upazilla_id").val()=="")
    {
        alert ('Please select zone, territory, district & upazilla! try again.');
    }
    else
    {
