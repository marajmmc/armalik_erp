        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div class="control-group">
                    <label class="control-label" for="textName"> Group Name: <?php echo $ugname; ?></label>
                    <div class="controls">
            ...
            <div class="widget-body">
                ...
                order by sm_id,st_order";
                        ...
                        <td align='left'>
                            <input type='checkbox' disabled='' class='checkbox_module' $chkMethod name='$result_array[sm_id]' onclick='selectallTask(this)' id='$result_array[sm_id]' value='$result_array[sm_id]'  />
                            ...
                            <input type='hidden' id='elmIndex[]' name='elmIndex[]' value='$i'/>
                                    ...
                                    echo "<td align='left'>
                            <input type='checkbox' class='checkbox_module' disabled='' $taskchkMethod onclick=selectallEvents(this,'$result_array[sm_id]') name='$result_array[sm_id]-$result_array[st_id]' value='$result_array[sm_id]-$result_array[st_id]'  />
                        ...
                        <td><input type='checkbox' class='checkbox_module' disabled='' $addchkMethod name='$result_array[sm_id]-$result_array[st_id]-Add' value='add' title='Add' onclick=selectallModuleTask(this,'$result_array[sm_id]','$result_array[sm_id]-$result_array[st_id]')  /></td>
                        <td><input type='checkbox' class='checkbox_module' disabled='' $savechkMethod name='$result_array[sm_id]-$result_array[st_id]-Save' value='save' title='Save' onclick=selectallModuleTask(this,'$result_array[sm_id]','$result_array[sm_id]-$result_array[st_id]')  /></td>
                        <td><input type='checkbox' class='checkbox_module' disabled='' $editchkMethod name='$result_array[sm_id]-$result_array[st_id]-Edit' value='edit' title='Edit' onclick=selectallModuleTask(this,'$result_array[sm_id]','$result_array[sm_id]-$result_array[st_id]')  /></td>
                        <td><input type='checkbox' class='checkbox_module' disabled='' $viewchkMethod name='$result_array[sm_id]-$result_array[st_id]-View' value='details' title='Detail's' onclick=selectallModuleTask(this,'$result_array[sm_id]','$result_array[sm_id]-$result_array[st_id] ')  /></td>                        
                        <td><input type='checkbox' class='checkbox_module' disabled='' $deletechkMethod name='$result_array[sm_id]-$result_array[st_id]-Delete' value='delete' title='Delete' onclick=selectallModuleTask(this,'$result_array[sm_id]','$result_array[sm_id]-$result_array[st_id]')  /></td>
                        <td><input type='checkbox' class='checkbox_module' disabled='' $reportchkMethod name='$result_array[sm_id]-$result_array[st_id]-Report' value='report' title='Report' onclick=selectallModuleTask(this,'$result_array[sm_id]','$result_array[sm_id]-$result_array[st_id]')  /></td>
                        <tr>";
