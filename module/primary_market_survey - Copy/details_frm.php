...
<div class="widget-body">
    <div class="control-group">
        ...
        <div class="controls">
            <select disabled id="zone_id" name="zone_id" class="span5" placeholder="Zone" validate="Require" onchange="load_district()" >
...
";
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select disabled id="product_master_type_id" name="product_master_type_id" class="span5" placeholder="Product Type" onchange="check_exist_data()" validate="Require">
                <?php
...
<tr>
    ...
    for($i=0; $i<$whole_count; $i++)
    {
        ?>
        <th colspan="2">
            <input disabled type="text" name="wholesaler_name[]" id="wholesaler_name[]" value="<?php echo $wholesaler[$i]['wholesaler_name'];?>" <?php if(isset($wholesaler[$i]['wholesaler_name']) && !empty($wholesaler[$i]['wholesaler_name'])){echo "readonly='readonly'";}?> class="span12" placeholder="Distributor <?php echo $i+1;?>" />
    ...
    while($row=$db->fetchAssoc($result))
    {
        ...
        <tr>
            ...
            for($i=0; $i<$whole_count; $i++)
            {
                ...
                ?>
                <td>
                    <input disabled type="text" name="sales_quantity[<?php echo $i;?>][]" value="<?php if(isset($sale_quantity) && !empty($sale_quantity)){echo $sale_quantity;};?>" <?php if(isset($sale_quantity) && !empty($sale_quantity)){echo "readonly='readonly'";}?> class="span12" onkeypress="return numbersOnly(event)" />
                </td>
                <td>
                    <input disabled type="text" name="market_size[<?php echo $i;?>][]" value="<?php if(isset($market_size) && !empty($market_size)){echo $market_size;}?>" <?php if(isset($market_size) && !empty($market_size)){echo "readonly='readonly'";}?> class="span12" onkeypress="return numbersOnly(event)" />
                </td>
            <?php
            }
            ?>
            <td>
                <input disabled type="text" name="sales_quantity_other[]" value="<?php if(isset($sale_quantity_other) && !empty($sale_quantity_other)){echo $sale_quantity_other;};?>" <?php if(isset($sale_quantity_other) && !empty($sale_quantity_other)){echo "readonly='readonly'";}?> class="span12" onkeypress="return numbersOnly(event)" />
            </td>
        </tr>
    <?php
    }
