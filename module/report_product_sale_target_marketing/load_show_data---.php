    ...
    <table class="table table-condensed table-striped table-hover table-bordered pull-left report" id="data-table">
        ...
        <tbody>
            ...
            if ($db->open()) {
                ...
                while ($result_array = $db->fetchAssoc())
                {
                    ...
                    @$total_bonus_kg = $total_bonus_kg + $result_array['total_bonus_kg'];

                    @$persentance = (($result_array['sale_target_persentance'] / $result_array['value']) * 100);
                    @$tpersentance = $tpersentance + $persentance;

                    ?>
                    <tr class="<?php echo $rowcolor; ?> pointer" id="tr_id<?php echo $i; ?>" onclick="get_rowID('<?php echo $result_array["varriety_id"] ?>', '<?php echo $i; ?>')">
                        <td>
                            <?php
                            if ($crop_name == '') {
                        ...
                        <td style="width:5%; text-align: right;"><?php echo number_format($result_array['total_bonus_kg'], 2); ?></td>
                        <td style="width:5%; text-align: right;">
                            <?php
                            $totaltbkg=$result_array['achieve_target_kg']+$result_array['total_bonus_kg'];
                            echo number_format($totaltbkg, 2);
                            ?>
                        </td>
        ...
        <tfoot>
            <tr>
                ...
                <td style="text-align: right;"><?php echo number_format(@$total_bonus_kg, 2) ?></td>
                <td style="text-align: right;">
                    <?php
                    $total_achieve_bonus=($aqnty+$total_bonus_kg);
                    echo number_format(@$total_achieve_bonus, 2)
                    ?>
                </td>
