...
echo $sql_uesr_group = "select 
                    ...
                    where $tbl" . "product_info.status='Active' $crop_id $varriety_id $product_type_id $warehouse_id
                        AND pack_size IN (select pack_size from $tbl" . "product_pricing where status='Active' $crop_id $varriety_id $product_type_id)
