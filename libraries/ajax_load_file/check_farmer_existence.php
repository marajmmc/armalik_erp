...
if ($_POST['farmers_name'] != "")
{
    ...
    $farmers_name = "AND farmers_name='".$name."'";
}
else
{
    $farmers_name = "";
...
echo $sql = "select id from $tbl" . "zi_crop_farmer_setup where del_status='0' $farmers_id $farmers_name $division_id $zone_id $territory_id $district_id $upazilla_id $crop_id $product_type_id $variety_id AND status='1'";
