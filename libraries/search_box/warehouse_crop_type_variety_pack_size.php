...
<table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table" >
    ...
    <tr>
        <td>
            <select id="warehouse_id" name="warehouse_id" class="span12" placeholder="Select Crop" validate="Require" >
                <?php
                include_once '../../libraries/ajax_load_file/load_warehouse.php';
                ?>
            </select>
        </td>
        <td>
